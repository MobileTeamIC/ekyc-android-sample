...
import static com.vnptit.idg.sdk.utils.KeyIntentConstants.IS_ENABLE_SCAN_QRCODE;
import static com.vnptit.idg.sdk.utils.KeyIntentConstants.IS_HIDDEN_DIPLOMA_IBETA;
import static com.vnptit.idg.sdk.utils.KeyIntentConstants.IS_SHOW_REQUIRED_PERMISSION_DECREE;
...
public class SampleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startEkycFace() {
        ...
        */
       intent.putExtra(HASH_IMAGE_COMPARE, "");
    ...
    private void startEkycOcr() {
        ...
        intent.putExtra(VALIDATE_DOCUMENT_TYPE, SDKEnum.ValidateDocumentType.Basic.getValue());
    ...
    private void startEkycFull() {
        ...
        // Giá trị này xác định việc có quét mã QR hay không
        intent.putExtra(IS_ENABLE_SCAN_QRCODE, true);


        // Giá trị này xác định việc có ẩn thông tin iBeta mã QR hay không
        intent.putExtra(IS_HIDDEN_DIPLOMA_IBETA, true);

        // Giá trị này xác định việc có hiển thị thông báo yêu cầu quyền truy cập hay không
        intent.putExtra(IS_SHOW_REQUIRED_PERMISSION_DECREE, true);
